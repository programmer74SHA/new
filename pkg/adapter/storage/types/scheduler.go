...
const (
	ScheduleTypeRecurring   ScheduleType = "RECURRING"   // Regular scheduled scans
...
type Schedule struct {
	...
	ScheduleType   ScheduleType `gorm:"column:schedule_type;type:enum('RECURRING','RUN_ONCE','IMMEDIATELY');not null;default:'RECURRING'"`
