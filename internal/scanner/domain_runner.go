...
func (r *DomainRunner) ExecuteDomainScan(ctx context.Context, scanner scannerDomain.ScannerDomain, scanJobID int64) error {
	...
	log.Printf("[DomainScanner] Scanner details: IP=%s, Port=%s, Domain=%s, Username=%s, AuthType=%s",
		scanner.IP, scanner.Port, scanner.Domain, scanner.Username, scanner.AuthenticationType)
